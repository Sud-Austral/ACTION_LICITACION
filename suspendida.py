...
def proceso2():
    print("Comenzamos suspendidas...")
    ref = pd.read_excel("https://github.com/Sud-Austral/ACTION_LICITACION/raw/main/licitaciones_suspendida_2019.xlsx")
    ...
    while avance < now:
        ...
        url = f"http://api.mercadopublico.cl/servicios/v1/publico/licitaciones.json?fecha={fecha}&estado=suspendida&ticket=BC2B1276-7EF0-48FA-9EA8-888BFD8D11FE"
        #print(url)
        flag = True
        while flag:
    ...
    tabla_final.to_excel("licitaciones_suspendida_2019.xlsx", index=False)
